...
----
Note that I also added a nodeSelectors so that you can select on which OpenShift nodes your want to deploy Lacework
spec:
      nodeSelector:
...
----
wget is https://raw.githubusercontent.com/marcredhat/lacework/master/lacework-k8s.yaml
----
